export   default [
    {
        name:'Blog Title',
        desc:'An AI tool that generate blog title depends on yout blog information and give you insight about what you want to work on ',
        category:'Blog',
    ...
    },
    {
        ...
        desc: 'This tool analyzes your input, like error messages and code',
